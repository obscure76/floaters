...
window.requestAnimFrame = (function(callback) {
      ...
      function createAlpha(char, x, y) {
          ...
          {
            case 'A':
              trolls.push(new Ball(x, y, 0, 0, blue));
              trolls.push(new Ball(x, y+20, 0, 0, blue));
              trolls.push(new Ball(x, y+40, 0, 0, blue));
              trolls.push(new Ball(x, y+60, 0, 0, blue));
              trolls.push(new Ball(x, y+80, 0, 0, blue));
              trolls.push(new Ball(x, y+100, 0, 0, blue));
              trolls.push(new Ball(x, y+120, 0, 0, blue));
              trolls.push(new Ball(x+60, y, 0, 0, blue));
              trolls.push(new Ball(x+60, y+20, 0, 0, blue));
              trolls.push(new Ball(x+60, y+40, 0, 0, blue));
              trolls.push(new Ball(x+60, y+60, 0, 0, blue));
              trolls.push(new Ball(x+60, y+80, 0, 0, blue));
              trolls.push(new Ball(x+60, y+100, 0, 0, blue));
              trolls.push(new Ball(x+60, y+120, 0, 0, blue));
              trolls.push(new Ball(x+20, y, 0, 0, blue));
              trolls.push(new Ball(x+40, y, 0, 0, blue));
              trolls.push(new Ball(x+20, y+60, 0, 0, blue));
              trolls.push(new Ball(x+40, y+60, 0, 0, blue));
              break;
            case 'B':
              trolls.push(new Ball(x, y, 0, 0, blue));
              trolls.push(new Ball(x, y+20, 0, 0, blue));
              ...
              trolls.push(new Ball(x+20, y+60, 0, 0, blue));
              trolls.push(new Ball(x+40, y+60, 0, 0, blue));
              trolls.push(new Ball(x+20, y+120, 0, 0, blue));
              trolls.push(new Ball(x+40, y+120, 0, 0, blue));
              break;
            case 'C':
              trolls.push(new Ball(x, y, 0, 0, blue));
              trolls.push(new Ball(x, y+20, 0, 0, blue));
            ...
            case 'I':
              ...
              trolls.push(new Ball(x+60, y+120, 0, 0, blue));
              trolls.push(new Ball(x+40, y+120, 0, 0, blue));
              trolls.push(new Ball(x+30, y+20, 0, 0, blue));
              trolls.push(new Ball(x+30, y+40, 0, 0, blue));
              trolls.push(new Ball(x+30, y+60, 0, 0, blue));
              trolls.push(new Ball(x+30, y+80, 0, 0, blue));
              trolls.push(new Ball(x+30, y+100, 0, 0, blue));
              break;
            case 'J':
              trolls.push(new Ball(x, y, 0, 0, blue));
              trolls.push(new Ball(x+20, y, 0, 0, blue));
            ...
            case 'K':
              ...
              trolls.push(new Ball(x, y+100, 0, 0, blue));
              trolls.push(new Ball(x, y+120, 0, 0, blue));
              trolls.push(new Ball(x+20, y+50, 0, 0, blue));
              trolls.push(new Ball(x+31, y+30, 0, 0, blue));
              trolls.push(new Ball(x+45, y+20, 0, 0, blue));
              trolls.push(new Ball(x+60, y, 0, 0, blue));
              trolls.push(new Ball(x+20, y+70, 0, 0, blue));
              trolls.push(new Ball(x+31, y+90, 0, 0, blue));
              trolls.push(new Ball(x+45, y+110, 0, 0, blue));
              trolls.push(new Ball(x+60, y+120, 0, 0, blue));
              break;
            case 'L':
              trolls.push(new Ball(x, y, 0, 0, blue));
            ...
            case 'M':
              ...
              trolls.push(new Ball(x+60, y+100, 0, 0, blue));
              trolls.push(new Ball(x+60, y+120, 0, 0, blue));
              trolls.push(new Ball(x+15, y+7, 0, 0, blue));
              trolls.push(new Ball(x+24, y+21, 0, 0, blue));
              trolls.push(new Ball(x+30, y+40, 0, 0, blue));
              trolls.push(new Ball(x+34, y+21, 0, 0, blue));
              trolls.push(new Ball(x+44, y+7, 0, 0, blue));
              break;
            case 'N':
              trolls.push(new Ball(x, y, 0, 0, blue));
              trolls.push(new Ball(x, y+20, 0, 0, blue));
              ...
              trolls.push(new Ball(x+60, y+100, 0, 0, blue));
              trolls.push(new Ball(x+60, y+120, 0, 0, blue));
              trolls.push(new Ball(x+15, y+10, 0, 0, blue));
              trolls.push(new Ball(x+22, y+30, 0, 0, blue));
              trolls.push(new Ball(x+30, y+50, 0, 0, blue));
              trolls.push(new Ball(x+38, y+70, 0, 0, blue));
              trolls.push(new Ball(x+44, y+90, 0, 0, blue));
              break;
            case 'O':
              trolls.push(new Ball(x, y, 0, 0, blue));
              trolls.push(new Ball(x, y+20, 0, 0, blue));
            ...
            case 'Q':
              ...
              trolls.push(new Ball(x+20, y+120, 0, 0, blue));
              trolls.push(new Ball(x+40, y+120, 0, 0, blue));
              trolls.push(new Ball(x+40, y+100, 0, 0, blue));
              trolls.push(new Ball(x+70, y+130, 0, 0, blue));
              trolls.push(new Ball(x+80, y+140, 0, 0, blue));
              break;
            case 'R':
              trolls.push(new Ball(x, y, 0, 0, blue));
              trolls.push(new Ball(x, y+20, 0, 0, blue));
            ...
            case 'T':
              ...
              trolls.push(new Ball(x+30, y+80, 0, 0, blue));
              trolls.push(new Ball(x+30, y+100, 0, 0, blue));
              trolls.push(new Ball(x+30, y+120, 0, 0, blue));
              break;
            case 'U':
              trolls.push(new Ball(x, y, 0, 0, blue));
              trolls.push(new Ball(x, y+20, 0, 0, blue));
            ...
            case 'V':
              trolls.push(new Ball(x, y, 0, 0, blue));
              trolls.push(new Ball(x+5, y+20, 0, 0, blue));
              trolls.push(new Ball(x+10, y+40, 0, 0, blue));
              trolls.push(new Ball(x+15, y+60, 0, 0, blue));
              trolls.push(new Ball(x+20, y+80, 0, 0, blue));
              trolls.push(new Ball(x+25, y+100, 0, 0, blue));
              trolls.push(new Ball(x+30, y+120, 0, 0, blue));
              trolls.push(new Ball(x+60, y, 0, 0, blue));
              trolls.push(new Ball(x+55, y+20, 0, 0, blue));
              trolls.push(new Ball(x+50, y+40, 0, 0, blue));
              trolls.push(new Ball(x+45, y+60, 0, 0, blue));
              trolls.push(new Ball(x+40, y+80, 0, 0, blue));
              trolls.push(new Ball(x+35, y+100, 0, 0, blue));
              break;
            case 'W':
              trolls.push(new Ball(x, y, 0, 0, blue));
              trolls.push(new Ball(x, y+20, 0, 0, blue));
              ...
              trolls.push(new Ball(x+60, y+100, 0, 0, blue));
              trolls.push(new Ball(x+60, y+120, 0, 0, blue));
              trolls.push(new Ball(x+10, y+110, 0, 0, blue));
              trolls.push(new Ball(x+20, y+100, 0, 0, blue));
              trolls.push(new Ball(x+30, y+90, 0, 0, blue));
              trolls.push(new Ball(x+40, y+100, 0, 0, blue));
              trolls.push(new Ball(x+50, y+110, 0, 0, blue));
              break;
            case 'X':
              trolls.push(new Ball(x, y, 0, 0, blue));
              trolls.push(new Ball(x+10, y+20, 0, 0, blue));
              trolls.push(new Ball(x+20, y+40, 0, 0, blue));
              trolls.push(new Ball(x+30, y+60, 0, 0, blue));
              trolls.push(new Ball(x+40, y+80, 0, 0, blue));
              trolls.push(new Ball(x+50, y+100, 0, 0, blue));
              trolls.push(new Ball(x+60, y+120, 0, 0, blue));
              trolls.push(new Ball(x+60, y, 0, 0, blue));
              trolls.push(new Ball(x+50, y+20, 0, 0, blue));
              trolls.push(new Ball(x+40, y+40, 0, 0, blue));
              trolls.push(new Ball(x+30, y+60, 0, 0, blue));
              trolls.push(new Ball(x+20, y+80, 0, 0, blue));
              trolls.push(new Ball(x+10, y+100, 0, 0, blue));
              trolls.push(new Ball(x, y+120, 0, 0, blue));
              break;
            case 'Y':
              trolls.push(new Ball(x, y, 0, 0, blue));
      ...
      function animate(canvas, balls, lastTime, mousePos, trolls) {
        var context = canvas.getContext('2d');
        // update
        var date = new Date();
        var time = date.getTime();
        var timeDiff = time - lastTime;
        updateBalls(canvas, trolls, timeDiff, mousePos);
        lastTime = time;
        ...
        requestAnimFrame(function() {
          animate(canvas, balls, lastTime, mousePos, trolls);
        });
      }
      ...
      tx.addEventListener('change', function() {
          ...
          {
              trolls=trolls.concat(createAlpha(s.charAt(i), x+i*90,y));
          }
          console.log(trolls.length);
          animate(canvas, balls, time, mousePos, trolls);
      });
      /*
